...
**Run locally:** open `index.html` in a browser or use a local server (e.g. `python3 -m http.server 8080`) so the background image and fonts load correctly.
